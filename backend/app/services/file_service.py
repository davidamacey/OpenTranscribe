...
from app.utils.db_helpers import (
    get_user_files_query, safe_get_by_id, get_file_tags, 
    add_tags_to_file, remove_tags_from_file, get_user_file_stats
)
...
class FileService:
    ...
    def search_files(self, user: User, query: str, limit: int = 50) -> List[MediaFile]:
        ...
        try:
            ...
            from app.api.endpoints.files.filtering import apply_search_filter, apply_transcript_search_filter
