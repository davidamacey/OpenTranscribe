"""v0.22.0 - Add speaker clustering tables for pre-clustering and batch labeling

Revision ID: v220_add_speaker_clusters
Revises: v211_add_sharing_constraints_and_indexes
...
revision = "v220_add_speaker_clusters"
down_revision = "v211_add_sharing_constraints_and_indexes"
branch_labels = None
depends_on = None
