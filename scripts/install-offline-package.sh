...
install_files() {
    ...
    cp "$SCRIPT_DIR/config/docker-compose.offline.yml" "$INSTALL_DIR/docker-compose.yml"
...
# OpenTranscribe Offline Configuration
...
# External LLM Providers (configure if needed)
OPENAI_API_KEY=
