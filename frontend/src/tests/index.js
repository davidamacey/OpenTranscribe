...
export { testFileDetail, mockFileData, mockComments, mockAuthData };
...
if (process.env.NODE_ENV !== 'production') {
  ...
  console.log(
    'Test utilities loaded. Run tests with window.runTests() or test specific components with window.testFileDetail()'
  );
}
