...
class YouTubeService:
    ...
    def _extract_technical_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            from app.tasks.transcription.metadata_extractor import extract_media_metadata, get_important_metadata
        ...
        try:
            ...
            try:
                ...
                if thumbnail_path:
                    ...
                    logger.warning(f"Failed to download YouTube thumbnail, will generate from video")
