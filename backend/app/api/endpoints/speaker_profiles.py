...
from app.models.media import (
    SpeakerProfile, Speaker, SpeakerCollection, SpeakerCollectionMember,
    MediaFile
)
from app.schemas.media import SpeakerProfile as SpeakerProfileSchema
...
from app.services.opensearch_service import (
    find_speaker_across_media, update_speaker_collections,
    move_speaker_to_profile_collection, get_speakers_in_collection
)
