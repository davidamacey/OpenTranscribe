...
def upgrade():
    ...
    op.create_index('ix_transcript_segment_media_file_id', 'transcript_segment', ['media_file_id'], unique=False)
    op.create_index('ix_transcript_segment_speaker_id', 'transcript_segment', ['speaker_id'], unique=False)
